<div class="kl-detail-invsum">
	<div class="involvedparties">Involved parties: {$involvedPartyCount}<div id="invsumcollapse" style="float: right"><a href="javascript:Toggle();">Show/Hide</a></div></div><div id="ToggleTarget">
