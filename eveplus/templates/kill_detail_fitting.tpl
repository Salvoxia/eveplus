<div class="kl-detail-fitting">
	...
	{/if}
		<div class="verified">
			{if $verify_yesno}
			<img class="verified-yes" src='{$theme_url}/img/verifiedyes.png' alt='Kill verified' title="Kill verified ID: {$verify_id}" />
			{else}
			<img class="verified-no" src='{$theme_url}/img/verifiedno.png' alt='Kill not verified' title="Kill not verified" />
			{/if}
		</div>
	</div>
</div>